...
// 컨트롤러 요청 파라미터
	...
	if(action.equals("list")) {
		...
		pageContext.forward("addrbook_account.jsp");
		
	}	// 주소록 수정 페이지 요청인 경우
	else if(action.equals("edit")) {
		AddrBook abook = ab.getDB(addrbook.getAb_id());
		if(!request.getParameter("upasswd").equals("jh0210")) {
		...
		response.sendRedirect("addrbook_register.jsp");
	} // 로그인 요청인 경우
	else if(action.equals("login")) {
		response.sendRedirect("addrbook_login.jsp");
	}
	else {
